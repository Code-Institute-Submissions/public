...
It is a fullty responsive website, to fit all screen sizes 
...
of course this app is top of the line , with the up to date features, with a mini feature of an api in the form of an weather API, this is the give the user a quick view of the up and coming app , 
...
while this feature does not have a database, it requires the data form a small json format in our js script, keepin this in mind to be very slim with the data bacause of googles page speed , 

This Project also makes use of HTML form validation , HTML video,  
 
### Existing Features
- 2 Contact forms , one on each page gives the user the abilty to contact the company thru the use of Formspree.io,
   this will provide the user with a " back to original site " option , so in turn keeping our user on our website
- ...
...
- [GoogleGeoLocationAPI](https://developers.google.com/maps/documentation/geolocation)
...
- Once you are satifactory with your project that you will be deploying, you will have to go your google developers console, go to the         Hosting tab & create a project, google will give you a default folder of PUBLISH,

- So now we have 2 projects/folders , one on Firebase & one on Your Local Machine ,
...
- Now we have a live static website.
  ...
  ## VERSION CONTROL
  The development project folder lives at this address
