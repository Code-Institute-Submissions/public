...
### FEATURES
##APP
Along side the main website , there is another element geered towrads the growth & marketing , which comes in the form of a start up & coming app to accompany the customer on there travels , of course this app is top of the line , with the up to date features. 

## API
With a mini feature of an api in the form of an weather API, this is the give the user a quick view of the up and coming app , 
...
- So now we have 3 projects/folders , one on Firebase & one on Your Local Machine & one on GitHub(Providing you versioned controlled your     project),
